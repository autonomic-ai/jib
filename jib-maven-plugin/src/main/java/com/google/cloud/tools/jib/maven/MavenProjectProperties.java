...
public class MavenProjectProperties implements ProjectProperties {
     ...
     */
    static MavenProjectProperties getForProject(MavenProject project, MavenSession session,
            Log log) {
    ...
    static boolean isProgressFooterEnabled(MavenSession session) {
        ...
        // Enables progress footer when ANSI is supported (Windows or System.console() not null and
        // TERM
        // not 'dumb').
     ...
     *
     * <p>
     * Examples: {@code "1.7" -> 7, "1.8.0_161" -> 8, "10" -> 10, "11.0.1" -> 11}
     *
