...
public class MojoCommon {
    ...
    /**
     * Check that the actual version satisfies required Jib version range when specified. No check
     * is performed if the provided Jib version is {@code null}, which should only occur during
     * debug.
     *
