...
public abstract class JibPluginConfiguration extends AbstractMojo {
    ...
    public static class ContainerParameters {
        ...
        // Note: `entrypoint` and `args` are @Nullable to handle inheriting values from the base
        // image
    ...
    Set<String> getTargetImageAdditionalTags() {
        ...
        List<String> tags =
                property != null ? ConfigurationPropertyValidator.parseListProperty(property)
                        : to.tags;
    ...
    boolean isContainerizable() {
        ...
        // Relative paths never have a colon on *nix nor Windows. This moduleSpecification could be
        // an
