...
public class JibPluginConfigurationTest {
    ...
    public void testSystemProperties() {
        ...
        Assert.assertEquals(
                ImmutableList.of("port1", "port2", "port3"),
        ...
        Assert.assertEquals(
                Arrays.asList(Paths.get("custom-jib")),
    ...
    public void testPomProperties() {
        ...
        project
                .getProperties()
                .setProperty("jib.extraDirectories.permissions",
                        "/test/file1=123,/another/file=456");
        List<PermissionConfiguration> permissions =
                testPluginConfiguration.getExtraDirectoryPermissions();
        Assert.assertEquals("/test/file1", permissions.get(0).getFile().get());
    ...
    public void testEmptyOrNullTags() {
        ...
        // Maven turns empty tags into null entries, and its possible to have empty tags in
        // jib.to.tags
    ...
    public void testDeprecatedSystemProperties() {
        ...
        Assert.assertEquals(
                Arrays.asList(Paths.get("custom-jib")),
                testPluginConfiguration.getExtraDirectories());
        sessionProperties.put("jib.extraDirectory.permissions",
                "/test/file13=650,/another/file24=777");
        List<PermissionConfiguration> permissions =
                testPluginConfiguration.getExtraDirectoryPermissions();
    ...
    public void testDeprecatedProperties() {
        ...
        Assert.assertEquals(
                Arrays.asList(Paths.get("this-is-extra")),
                testPluginConfiguration.getExtraDirectories());
