...
public class MavenSettingsProxyProviderTest {
    ...
    public static void setUpTestFixtures() {
        noActiveProxiesSettings =
                SettingsFixture.newSettings(
                        Paths.get(
                                "src/test/resources/maven/settings/no-active-proxy-settings.xml"));
        httpOnlyProxySettings =
                SettingsFixture.newSettings(
                        Paths.get(
                                "src/test/resources/maven/settings/http-only-proxy-settings.xml"));
        httpsOnlyProxySettings =
                SettingsFixture.newSettings(
                        Paths.get(
                                "src/test/resources/maven/settings/https-only-proxy-settings.xml"));
        mixedProxyEncryptedSettings =
                SettingsFixture.newSettings(
                        Paths.get(
                                "src/test/resources/maven/settings/encrypted-proxy-settings.xml"));
        badProxyEncryptedSettings =
                SettingsFixture.newSettings(
                        Paths.get(
                                "src/test/resources/maven/settings/bad-encrypted-proxy-settings.xml"));
        settingsDecrypter =
    ...
    @Test
    public void testActivateHttpAndHttpsProxies_firstActiveHttpProxy()
